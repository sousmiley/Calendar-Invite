package project.assignment.importantdaystracker.webappserver.gson.extras;
/**
 * Registers sub-classes as subtypes of the parent type (base class),
 * with an additional member variable in the base class
 */
